...
Able2 is a multi-purpose Electron desktop app in use at multiple news stations across the country. Able2 is able to download media from various online services, record video and audio from a user's desktop and convert and format video, image and audio files for air.
...
For official releases of Able2 please download from the following repo:
